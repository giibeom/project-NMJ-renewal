...
import static alex.toy.nmj.fixture.MemberFixture.관리자_회원_짱구;
...
class MemberTest {
    ...
    class 회원_인스턴스_생성_시 {
        ...
        class Context_with_user_type {
            ...
            private Member 일반_회원 = 일반_회원_기범.회원_엔티티_생성();

            @Test
            @DisplayName("회원 상태는 NORMAL이다")
            void it_status_normal() {
        ...
        class Context_with_store_type {
            ...
            private Member 매장_회원 = 매장_회원_Alex.회원_엔티티_생성();
        ...
        class Context_with_admin_type {
            ...
            private Member 관리자_회원 = 관리자_회원_짱구.회원_엔티티_생성();
    ...
    class 회원_정보_수정_시 {
        ...
        class Context_with_change_data {
            ...
            private Member 기존_회원_정보 = 일반_회원_기범.회원_엔티티_생성();
            private Member 변경할_회원_정보 = 일반_회원_기범에서_이름과_전화번호_수정.회원_엔티티_생성();

            @Test
            @DisplayName("값이 있는 컬럼만 수정된다")
            void it_change_not_blank() {
    ...
    class 회원_정보_삭제_시 {
        ...
        void it_change_member_status_deleted() {
            기존_회원_정보.delete();
